...
fase1.create = function() {
  ...
  */
  ...
  //criando o mapa
  map = this.add.tilemap("fase1");
  chão = map.addTilesetImage("plataforma", "plataforma");
  parede = map.addTilesetImage("parede", "parede");
  camada1 = map.createStaticLayer("camada1", [chão, parede], 0, 0);
  ...
  this.physics.add.collider(player, camada1);
